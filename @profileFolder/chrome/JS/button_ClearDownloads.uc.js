    ...
    class ClearDLPanel {
        ...
        async makeButton() {
            ...
            for (const [key, val] of Object.entries({
                ...
                class: DownloadsView.downloadsHistory.className || 'downloadsPanelFooterButton subviewbutton panel-subview-footer-button toolbarbutton-1',
